<template>
  <q-page class="q-pa-md bg-orange-1 fit">
    <div class="q-gutter-md items-start justify-start">
      <div class="row items-center q-gutter-md">
        <div>
          <h3 class="q-ma-none">Users</h3>
        </div>
        <div>
      ...
      <table-user @open-view="({ context }) => { view.context = context; view.open = true }"
        @edit="({ context }) => { form.data = context; form.mode = 'Edit'; form.open = true }"></table-user>
    </div>
    <q-dialog v-model="form.open">
      <form-user :formData="form.data" :mode="form.mode" @update-complete="
  form.open = false;
